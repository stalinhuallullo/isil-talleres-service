...
public class Estudiante {
    ...
    @OneToOne
    @JoinColumn(name = "sanguineo_id")
    private GrupoSanguineo sanguineo;

    private String departamento;
    private String provincia;
    private String distrito;
    private Long apoderado_id;
    ...
    public GrupoSanguineo getSanguineo() {
        return sanguineo;
    }

    public void setSanguineo(GrupoSanguineo sanguineo) {
